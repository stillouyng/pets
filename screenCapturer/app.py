...
def main_l():
    ...
    Label(t, background="#0049e6", text="Screen recorder", foreground="black", font=('Comic sans MS', 19)).place(x=10,
                                                                                                                 y=0)
    Label(t, background="black", height=30, width=500).place(x=0, y=50)
    p1 = Button(t, text="Start recording", font=('Comic sans MS', 15), command=ply, background="#0049e6",
                foreground="black", activebackground="white", activeforeground="black")
    p2 = Button(t, text="Stop recording", font=('Comic sans MS', 15), command=stp, background="#0049e6",
                foreground="black", activebackground="white", activeforeground="black")
    p3 = Button(t, text="Release video", font=('Comic sans MS', 15), command=rls, background="#0049e6",
                foreground="black", activebackground="white", activeforeground="black")
    Button(t, text="PRAVV company", font=('Comic sans MS', 13), command=ghb, background="grey", foreground="white",
           activebackground="white", activeforeground="black").place(x=10, y=230)
    p1.place(x=15, y=80)
